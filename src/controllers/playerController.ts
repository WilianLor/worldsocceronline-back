...
export default {
    ...
    async create(req:Request, res:Response){
        const {firstName, lastName, position, overall, age, countryId, teamId, transferAmount, baseSalary, salary, initialDate, finalDate, terminationFine} = req.body
        ...
        try {
            ...
            if(teamId !== ""){
                ...
                if(terminationFine !== undefined && terminationFine < 1){
                    return res.status(400).send({error: 'Invalid termination fine amount'})
                }

                player = {firstName, lastName, position, overall, age, countryId, transferAmount, baseSalary, teamId, activeContract: {teamId, salary, initialDate, finalDate, terminationFine}}
                ...
                player = {firstName, lastName, position, overall, age, countryId, transferAmount, baseSalary}
